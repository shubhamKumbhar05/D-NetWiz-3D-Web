...
export default function ConceptVisualizations({ layerId, conceptId, triggerScenario, triggerClosing, onStateUpdate, segmentPhase, inOrderMode, ackIsRunning, onACKMessage, ackResetTrigger, packetLossEnabled, ackLossEnabled, flowControlIsRunning, onFlowControlMessage, flowControlResetTrigger, flowControlDrainSpeed, flowControlSimulateFullBuffer, flowControlClearBuffer, tcpUdpIsRunning, tcpUdpIsTCP, onTcpUdpMessage, tcpUdpResetTrigger, tcpUdpSimulateLoss, multiplexingIsRunning, onMultiplexingMessage, multiplexingResetTrigger, congestionCtrlIsRunning, onCongestionCtrlMessage, congestionCtrlResetTrigger, onCongestionCtrlStateUpdate, congestionCtrlNetworkCongestionTrigger }) {
  ...
  return <VisualizationComponent conceptId={conceptId} triggerScenario={triggerScenario} triggerClosing={triggerClosing} onStateUpdate={onStateUpdate} segmentPhase={segmentPhase} inOrderMode={inOrderMode} ackIsRunning={ackIsRunning} onACKMessage={onACKMessage} ackResetTrigger={ackResetTrigger} packetLossEnabled={packetLossEnabled} ackLossEnabled={ackLossEnabled} flowControlIsRunning={flowControlIsRunning} onFlowControlMessage={onFlowControlMessage} flowControlResetTrigger={flowControlResetTrigger} flowControlDrainSpeed={flowControlDrainSpeed} flowControlSimulateFullBuffer={flowControlSimulateFullBuffer} flowControlClearBuffer={flowControlClearBuffer} tcpUdpIsRunning={tcpUdpIsRunning} tcpUdpIsTCP={tcpUdpIsTCP} onTcpUdpMessage={onTcpUdpMessage} tcpUdpResetTrigger={tcpUdpResetTrigger} tcpUdpSimulateLoss={tcpUdpSimulateLoss} multiplexingIsRunning={multiplexingIsRunning} onMultiplexingMessage={onMultiplexingMessage} multiplexingResetTrigger={multiplexingResetTrigger} congestionCtrlIsRunning={congestionCtrlIsRunning} onCongestionCtrlMessage={onCongestionCtrlMessage} congestionCtrlResetTrigger={congestionCtrlResetTrigger} onCongestionCtrlStateUpdate={onCongestionCtrlStateUpdate} congestionCtrlNetworkCongestionTrigger={congestionCtrlNetworkCongestionTrigger} />
}
