 ...
 */
export default function ConceptVisualizations({ layerId, conceptId, triggerScenario, triggerClosing, onStateUpdate, segmentPhase, inOrderMode, ackIsRunning, onACKMessage, ackResetTrigger, packetLossEnabled, ackLossEnabled, flowControlIsRunning, onFlowControlMessage, flowControlResetTrigger, flowControlDrainSpeed, flowControlSimulateFullBuffer, flowControlClearBuffer, tcpUdpIsRunning, tcpUdpIsTCP, onTcpUdpMessage, tcpUdpResetTrigger, tcpUdpSimulateLoss, isXRayActive, setIsXRayActive, isFragmentationAttempting, isDFEnabled, isFragmentationOutOfOrder, showICMPError }) {
  ...
  return <VisualizationComponent conceptId={conceptId} triggerScenario={triggerScenario} triggerClosing={triggerClosing} onStateUpdate={onStateUpdate} segmentPhase={segmentPhase} inOrderMode={inOrderMode} ackIsRunning={ackIsRunning} onACKMessage={onACKMessage} ackResetTrigger={ackResetTrigger} packetLossEnabled={packetLossEnabled} ackLossEnabled={ackLossEnabled} flowControlIsRunning={flowControlIsRunning} onFlowControlMessage={onFlowControlMessage} flowControlResetTrigger={flowControlResetTrigger} flowControlDrainSpeed={flowControlDrainSpeed} flowControlSimulateFullBuffer={flowControlSimulateFullBuffer} flowControlClearBuffer={flowControlClearBuffer} tcpUdpIsRunning={tcpUdpIsRunning} tcpUdpIsTCP={tcpUdpIsTCP} onTcpUdpMessage={onTcpUdpMessage} tcpUdpResetTrigger={tcpUdpResetTrigger} tcpUdpSimulateLoss={tcpUdpSimulateLoss} isXRayActive={isXRayActive} setIsXRayActive={setIsXRayActive} isFragmentationAttempting={isFragmentationAttempting} isDFEnabled={isDFEnabled} isFragmentationOutOfOrder={isFragmentationOutOfOrder} showICMPError={showICMPError} />
}
